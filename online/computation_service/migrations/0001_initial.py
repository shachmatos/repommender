# Generated by Django 2.0.5 on 2018-06-05 07:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('repo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='computation_service.Repository')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='computation_service.User')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='recommendation',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='computation_service.User'),
        ),
